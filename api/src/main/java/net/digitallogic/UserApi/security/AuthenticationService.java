...
import net.digitallogic.UserApi.security.UserAuthentication.UserAuthenticationBuilder;
...
import static net.digitallogic.UserApi.tables.AuthorityEntity.AUTHORITY_ENTITY;
import static net.digitallogic.UserApi.tables.RoleAuthorityLookup.ROLE_AUTHORITY_LOOKUP;
import static net.digitallogic.UserApi.tables.RoleEntity.ROLE_ENTITY;
import static net.digitallogic.UserApi.tables.UserEntity.USER_ENTITY;
import static net.digitallogic.UserApi.tables.UserRoleLookup.USER_ROLE_LOOKUP;
import static net.digitallogic.UserApi.tables.UserStatus.USER_STATUS;

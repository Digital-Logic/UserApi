...
import net.digitallogic.UserApi.persistence.dto.security.UserAuthenticationDto;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        throws AuthenticationException, IOException, ServletException {
            ...
            try {
               ...
               throw new BadRequestException(ErrorCode.INVALID_JSON_DATA, MessageTranslator.InvalidJson());
            }

...
import net.digitallogic.UserApi.web.error.exceptions.HttpRequestException;
...
public class ErrorResponse {
	...
	public ErrorResponse(HttpStatus code, ErrorCode reason, @Nullable String message, @Nullable List<ErrorBlock> errors) {
		this.code = code;
		this.reason = reason;

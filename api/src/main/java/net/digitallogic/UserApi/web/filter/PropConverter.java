...
import net.digitallogic.UserApi.web.filter.SpecSupport.FilterBuilder;
import net.digitallogic.UserApi.web.filter.operators.Operator;
...
import static net.digitallogic.UserApi.web.filter.SpecSupport.getConverter;
